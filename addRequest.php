<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sql = "INSERT INTO reqs (pType, title, descript, price, deposit, expiry, username)" . " VALUES ($type, '$title', '$desc', $price, $deposit, '$expiry', '$username')";
...
<body>
    ...
    <form method = "post" action = "addRequest.php">
        ...
        <label for = "deposit">Max Deposit (Rs.)</label>
